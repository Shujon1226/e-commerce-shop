...
Route::get('/category-product', [ShoppingController::class, 'categoryProduct'])->name('category-product');
Route::get('/product-detail', [ShoppingController::class, 'productDetail'])->name('product-detail');
...
Route::middleware(['auth:sanctum', 'verified'])->post('/admin-login', [DashboardController::class, 'login'] )->name('admin-login');
