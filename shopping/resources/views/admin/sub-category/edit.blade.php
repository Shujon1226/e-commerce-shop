            ...
            <div class="col-md-10 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title text-center text-info">Edit Sub Category Form</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('update-sub-category', ['id' => $subCategory->id]) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" name="description" class="form-control" placeholder="Sub Category Description">{{ $sub_category->description }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <img src="{{ asset($sub_category->image) }}" alt="" style="height: 100px; width: 130px"/>
                                </div>
                            </div>

                            <div class="form-layout-footer">
                                <button type="submit" class="btn btn-info ">Update New Sub Category</button>
                            </div>
